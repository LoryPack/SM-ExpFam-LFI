...
# TRAIN THE NNs
python3 scripts/train_net.py SM gaussian --nets_folder net-SM --epochs 500 --lr_data 0.0003 --lr_theta 0.003 \
    --update --bn_mom 0.9 --epochs_before_early_stopping 150 --epochs_test_interval 10
python3 scripts/train_net.py FP gaussian --nets_folder net-FP --epochs 1000 --lr_data 0.01 --no_scheduler --epochs_before_early_stopping 300 --epochs_test_interval 25
...
python3 plot_scripts/plot_bivariate.py gaussian --inference_folder Exc-SM/30_inn_steps --start 3 --n_obs 4

# final wass distance plot:
n_observations=100
python3 plot_scripts/compare_inference_results_diff_techniques.py gaussian final --n_obs $n_observations --subsample_size 10000 --inference_folder_exchange_SM Exc-SM/30_inn_steps --load_exchange_SM_if_available

# Wass dist plots vs iterations; these may take a while
python3 plot_scripts/compare_inference_results_diff_techniques.py gaussian ABC --n_obs $n_observations --subsample_size 1000 --inference_folder_exchange_SM Exc-SM/30_inn_steps --load_exchange_SM_if_available
python3 plot_scripts/compare_inference_results_diff_techniques.py gaussian SL --n_obs $n_observations --subsample_size 1000 --inference_folder_exchange_SM Exc-SM/30_inn_steps --load_exchange_SM_if_available
python3 plot_scripts/compare_inference_results_diff_techniques.py gaussian RE --n_obs $n_observations --subsample_size 1000 --inference_folder_exchange_SM Exc-SM/30_inn_steps --load_exchange_SM_if_available
