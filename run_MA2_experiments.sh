...
mkdir results/MA2/Exc-SSM
mkdir results/MA2/Exc-SSM/10_inn_steps
mkdir results/MA2/Exc-SSM/30_inn_steps
mkdir results/MA2/Exc-SSM/100_inn_steps
mkdir results/MA2/Exc-SSM/200_inn_steps
mkdir results/MA2/net-FP
mkdir results/MA2/net-SM
mkdir results/MA2/net-SSM
...
python3 scripts/train_net.py SSM MA2 --nets_folder net-SSM --epochs 500 --lr_data 0.001 --lr_theta 0.001 \
    --update --bn_mom 0.9 --epochs_before_early_stopping 100 --epochs_test_interval 25
...
python3 plot_scripts/plot_learned_stats.py MA2 --nets_folder net-SSM --no_bn --n_obs 1000
python3 plot_scripts/plot_learned_nat_params.py MA2 --nets_folder net-SSM --n_obs 1000
...
python3 plot_scripts/plot_bivariate.py SM MA2 --inference_folder Exc-SM/100_inn_steps --start 80 --n_obs 81
python3 plot_scripts/plot_bivariate.py SSM MA2 --inference_folder Exc-SSM/100_inn_steps --start 80 --n_obs 81
python3 plot_scripts/plot_bivariate.py SM MA2 --inference_folder ABC-SM --start 80 --n_obs 81 --inference_technique ABC --n_samples 1000
python3 plot_scripts/plot_bivariate.py SSM MA2 --inference_folder ABC-SSM --start 80 --n_obs 81 --inference_technique ABC --n_samples 1000
python3 plot_scripts/plot_bivariate.py True MA2 --inference_folder observations --start 80 --n_obs 81
# final wass distance plot:
n_observations=100
python3 plot_scripts/compare_inference_results_diff_techniques.py MA2 final --n_obs $n_observations --subsample_size 10000 --inference_folder_exchange_SM Exc-SM/100_inn_steps --inference_folder_exchange_SSM Exc-SSM/100_inn_steps

# Wass dist plots vs iterations; these may take a while
python3 plot_scripts/compare_inference_results_diff_techniques.py MA2 ABC --n_obs $n_observations --subsample_size 1000 --inference_folder_exchange_SM Exc-SM/100_inn_steps --load_exchange_SM_if_available --load_exchange_SSM_if_available
python3 plot_scripts/compare_inference_results_diff_techniques.py MA2 SL --n_obs $n_observations --subsample_size 1000 --inference_folder_exchange_SM Exc-SM/100_inn_steps --load_exchange_SM_if_available --load_exchange_SSM_if_available
python3 plot_scripts/compare_inference_results_diff_techniques.py MA2 RE --n_obs $n_observations --subsample_size 1000 --inference_folder_exchange_SM Exc-SM/100_inn_steps --load_exchange_SM_if_available --load_exchange_SSM_if_available
