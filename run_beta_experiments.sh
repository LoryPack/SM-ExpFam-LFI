...
python3 scripts/train_net.py FP beta --nets_folder net-FP --epochs 1000 --lr_data 0.01  --epochs_before_early_stopping 250 --epochs_test_interval 50
...
python3 plot_scripts/plot_bivariate.py beta --inference_folder Exc-SM/30_inn_steps --start 3 --n_obs 4

# final wass distance plot:
n_observations=100
python3 plot_scripts/compare_inference_results_diff_techniques.py beta final --n_obs $n_observations --subsample_size 10000 --inference_folder_exchange_SM Exc-SM/30_inn_steps --load_exchange_SM_if_available

# Wass dist plots vs iterations; these may take a while
python3 plot_scripts/compare_inference_results_diff_techniques.py beta ABC --n_obs $n_observations --subsample_size 1000 --inference_folder_exchange_SM Exc-SM/30_inn_steps --load_exchange_SM_if_available
python3 plot_scripts/compare_inference_results_diff_techniques.py beta SL --n_obs $n_observations --subsample_size 1000 --inference_folder_exchange_SM Exc-SM/30_inn_steps --load_exchange_SM_if_available
python3 plot_scripts/compare_inference_results_diff_techniques.py beta RE --n_obs $n_observations --subsample_size 1000 --inference_folder_exchange_SM Exc-SM/30_inn_steps --load_exchange_SM_if_available
