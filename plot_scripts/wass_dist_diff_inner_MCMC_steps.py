...
# plt.show()
plt.savefig(results_folder + f"{args.inferences_folder}_wass_dist_different_inner_MCMC_steps.png")
plt.close()
...
# plt.show()
plt.savefig(results_folder + f"{args.inferences_folder}_RMSE_post_mean_different_inner_MCMC_steps.png")
plt.close()
...
plt.savefig(results_folder + f"{args.inferences_folder}_joint_boxplot_different_inner_MCMC_steps.pdf", bbox_inches=bbox_inches)
plt.close()
