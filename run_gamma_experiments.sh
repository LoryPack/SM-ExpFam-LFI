...
python3 plot_scripts/plot_bivariate.py gamma --inference_folder Exc-SM/30_inn_steps --start 3 --n_obs 4

# final wass distance plot:
n_observations=100
python3 plot_scripts/compare_inference_results_diff_techniques.py gamma final --n_obs $n_observations --subsample_size 10000 --inference_folder_exchange_SM Exc-SM/30_inn_steps --load_exchange_SM_if_available

# Wass dist plots vs iterations; these may take a while
python3 plot_scripts/compare_inference_results_diff_techniques.py gamma ABC --n_obs $n_observations --subsample_size 1000 --inference_folder_exchange_SM Exc-SM/30_inn_steps --load_exchange_SM_if_available
python3 plot_scripts/compare_inference_results_diff_techniques.py gamma SL --n_obs $n_observations --subsample_size 1000 --inference_folder_exchange_SM Exc-SM/30_inn_steps --load_exchange_SM_if_available
python3 plot_scripts/compare_inference_results_diff_techniques.py gamma RE --n_obs $n_observations --subsample_size 1000 --inference_folder_exchange_SM Exc-SM/30_inn_steps --load_exchange_SM_if_available
